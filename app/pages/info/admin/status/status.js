    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          ...
          var houRoom = houBuilding[that.data.index] + that.data.indexLou + that.data.indexRoom;
          console.log(houRoom);
          wx.request({
            url: 'http://localhost:8888/api/classroom?houRoom=' + houRoom + '&arrayTimePeiodIdx=' + that.data.indexPeriod + '&status=S',
            header: {
